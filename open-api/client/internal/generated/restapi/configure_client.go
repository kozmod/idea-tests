...
import (
	...
	"github.com/kozmod/idea-tests/open-api/client/internal/generated/restapi/operations/hello"
)

//go:generate swagger generate server --target ../../generated --name Client --spec ../../../swagger/swagger.yml --template-dir ./swagger-templates/templates --principal interface{}

func configureFlags(api *operations.ClientAPI) {
