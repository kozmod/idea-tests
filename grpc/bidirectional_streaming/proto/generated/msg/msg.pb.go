...
var file_msg_msg_proto_rawDesc = []byte{
	...
	0x03, 0x6d, 0x73, 0x67, 0x22, 0x1b, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x2f, 0x0a, 0x03, 0x4d, 0x73, 0x67, 0x12, 0x28, 0x0a, 0x03,
	0x4d, 0x61, 0x78, 0x12, 0x0c, 0x2e, 0x6d, 0x73, 0x67, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x0d, 0x2e, 0x6d, 0x73, 0x67, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x05, 0x5a, 0x03, 0x6d, 0x73, 0x67, 0x62, 0x06, 0x70,
...
var file_msg_msg_proto_depIdxs = []int32{
	0, // 0: msg.Msg.Max:input_type -> msg.Request
	1, // 1: msg.Msg.Max:output_type -> msg.Response
...
type MsgClient interface {
	Max(ctx context.Context, opts ...grpc.CallOption) (Msg_MaxClient, error)
}
...
func (c *msgClient) Max(ctx context.Context, opts ...grpc.CallOption) (Msg_MaxClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Msg_serviceDesc.Streams[0], "/msg.Msg/Max", opts...)
	if err != nil {
		return nil, err
	}
	x := &msgMaxClient{stream}
	return x, nil
}

type Msg_MaxClient interface {
	Send(*Request) error
	Recv() (*Response, error)
	grpc.ClientStream
}

type msgMaxClient struct {
	grpc.ClientStream
}

func (x *msgMaxClient) Send(m *Request) error {
	return x.ClientStream.SendMsg(m)
}

func (x *msgMaxClient) Recv() (*Response, error) {
	m := new(Response)
...
func (*UnimplementedMsgServer) Max(Msg_MaxServer) error {
...
func _Msg_Max_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(MsgServer).Max(&msgMaxServer{stream})
}

type Msg_MaxServer interface {
	Send(*Response) error
	Recv() (*Request, error)
	grpc.ServerStream
}

type msgMaxServer struct {
	grpc.ServerStream
}

func (x *msgMaxServer) Send(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *msgMaxServer) Recv() (*Request, error) {
	m := new(Request)
